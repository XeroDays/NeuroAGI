...
responsible for enforcement by opening a **private report** via GitHub:

1. Go to [XeroDays/Open-Health Issues](https://github.com/XeroDays/Open-Health/issues).
2. Click **New issue** and choose to contact maintainers privately if GitHub offers that option, or open an issue
   with the title `[Code of Conduct]` and mark it sensitive. Maintainers will restrict visibility as appropriate.

Alternatively, if you have a direct relationship with a maintainer, you may reach out through existing project
communication channels you already use with them.
